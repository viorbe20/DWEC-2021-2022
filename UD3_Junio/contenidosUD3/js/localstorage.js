/**
 * @file (OPCIONAL) Crea el sitio que demuestre el uso del localStorage. Para ello: 
Usa <label> para indicar clave o valordiferencia innertext y innerhtml
...

{
  document.addEventListener("DOMContentLoaded", function () {
    ...
    lengthItemsBtn.addEventListener("click", function () {
      lengthItemsSpan.innerText = localStorage.length;
    });
  });
}
